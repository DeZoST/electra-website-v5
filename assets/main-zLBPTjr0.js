(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const l of n.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();function b(o){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",o):o()}function L(){const o=document.createElement("header");o.className="header",o.innerHTML=`
    ...
    `;const e=document.querySelector("main");o==="first"?e.prepend(t):e.appendChild(t)}const f=o=>{const t=document.querySelector("main"),e=window.innerHeight;window.requestAnimationFrame(()=>{t.style.transform=`translateY(-${e*o}px)`})},E=(o,t)=>{let e=0,a=0;const i=l=>{e=l.touches[0].clientY},n=l=>{if(scrollDisabled)return;const r=l.changedTouches[0].clientY,d=e-r;d>100&&a<o.length-1?a++:d<-100&&a>0&&a--,t(a)};window.addEventListener("touchstart",i,{passive:!0}),window.addEventListener("touchend",n,{passive:!0})};let _=!1;const h=(o,t="Unknown")=>{_=o},A=o=>{let t=0,e=!1;const a=document.querySelectorAll(".indicator"),i=document.querySelectorAll(".nav__link a"),n=s=>{if(e||_)return;const c=s.deltaY;e=!0,c>0&&t<o.length-1?t++:c<0&&t>0&&t--,f(t),r(a[t]),setTimeout(()=>{e=!1},600)},l=(s,c)=>{let u;return function(...m){u||(s.apply(this,m),u=!0,setTimeout(()=>u=!1,c))}};window.addEventListener("wheel",l(n,600)),E(o,s=>{t=s,r(a[t])});function r(s){a.forEach(c=>{c.classList.remove("active")}),s&&s.classList.add("active")}const d=new IntersectionObserver(s=>{s.forEach(c=>{if(c.isIntersecting){const u=Array.from(o).indexOf(c.target);t=u,c.target.classList.add("section-visible"),r(document.querySelector(`.indicator[data-target="#${o[u].id}"]`))}else c.target.classList.remove("section-visible")})},{threshold:.7});o.forEach(s=>d.observe(s)),a.forEach(s=>{s.addEventListener("click",c=>{c.preventDefault();const u=s.getAttribute("data-target"),m=document.querySelector(u);m&&(t=Array.from(o).indexOf(m),f(t),r(s))})}),i.forEach(s=>{s.addEventListener("click",c=>{c.preventDefault();const u=s.getAttribute("href"),m=document.querySelector(u);m&&(t=Array.from(o).indexOf(m),f(t),r(a[t]))})})};function g(o,t){fetch(o).then(e=>e.json()).then(e=>{const a=document.body.getAttribute("data-type"),i=document.querySelector("#about"),n=e[t];if(!n){console.error("No projects found for this section:",t);return}n.forEach(r=>{const d=document.createElement("section");d.id=`${r.id}`,d.className="featured__project section container";const s=a==="home"?`<a class="featured__project__link" href="${r.details.link}">${r.details.linkText}</a>`:"";d.innerHTML=`
                    <div class="featured__project__container">
                        ...
                        <div class="featured__project__wrapper">
                            ...
                            <div class="featured__project__details__container">
                                ...
                                <div class="featured__project__details">
                                    <h3 class="featured__project__company">${r.details.company}</h3>
                                    <h3 class="featured__project__title">${r.details.title}</h3>
                                </div>
                                ${s}
                            </div>
                        </div>
                    </div>
                `,i.insertAdjacentElement("beforebegin",d)});const l=document.querySelectorAll("section");A(l)}).catch(e=>console.error("Error loading projects:",e))}function S(){const o=document.createElement("div");o.id="videoModal",o.className="modal",o.innerHTML=`
        <div class="modal-content"></div>
    `,document.body.appendChild(o);const t=document.querySelector(".container");let e;const a=n=>{h(!0,"Modal Open"),e&&e.remove(),setTimeout(()=>{e=document.createElement("mux-player"),e.id="muxPlayer",e.setAttribute("stream-type","on-demand"),e.setAttribute("accent-color","#ff4e00"),e.setAttribute("disable-cookies",""),e.setAttribute("autoplay",""),e.setAttribute("controls","");const l=n.dataset.playbackId;e.setAttribute("playback-id",l),o.querySelector(".modal-content").appendChild(e),e.addEventListener("loadeddata",()=>{e.play().catch(r=>{console.warn("Video playback failed:",r)})}),o.style.display="flex",t.classList.add("blur-background")},100)},i=()=>{h(!1,"Modal Close"),o.style.display="none",t.classList.remove("blur-background"),e&&typeof e.pause=="function"&&(e.pause(),setTimeout(()=>{e.remove(),e=null},100))};return window.onclick=n=>{n.target===o&&i()},document.addEventListener("click",n=>{const l=n.target.closest(".featured__project__video");l&&a(l)}),{openModal:a,closeModal:i}}const k=()=>{const o=document.getElementById("menu-toggle"),t=document.createElement("div");t.classList.add("mobile-menu"),t.style.display="none",t.innerHTML=`
